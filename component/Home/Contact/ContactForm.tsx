const ContactForm = () => {
  return (
    <div className="bg-[#140c1c] rounded-lg p-4 sm:p-10">
      ...
      <p className="text-gray-400 mt-3 lg:text-base text-xs md:text-sm">
        I'm always open to discussing
        new projects, opportunities, and
        collaborations. Whether you're
        looking for a full-stack
        developer, need help with
        frontend or backend, or just
        want to chat about ideas, feel
        free to reach out!
      </p>
      {/* form fields */}
      <form className="mt-8 block w-full overflow-hidden">
        ...
        >
          <input
            ...
            rounded-md border-[1.5px] border-gray-200 outline-none w-full"
          />
          <input
            type="text"
        ...
        <div
          className="flex mt-5 flex-col md:flex-row items-center 
        justify-between gap-4"
        >
          <input
            type="email"
